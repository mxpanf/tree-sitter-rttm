...
enum {
  ...
  anon_sym_NON_SPEECH = 10,
  anon_sym_NON_DASHSPEECH = 11,
  sym_comment = 12,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [11] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(17),
  [14] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(2),
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1),
  [19] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__line, 1),
  [23] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [25] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__line, 1),
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_signal_look_time, 1),
  [29] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_signal_look_time, 1),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entry, 10, .production_id = 1),
  [33] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_entry, 10, .production_id = 1),
  ...
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_event_type, 1),
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file_id, 1),
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_channel, 1),
  [61] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_speaker_type, 1),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_speaker_id, 1),
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_duration, 1),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_confidence, 1),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_orthography, 1),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_start_time, 1),
